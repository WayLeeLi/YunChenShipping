...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260722144625_AddDeliveryMethodSetting'
)
BEGIN
    CREATE TABLE [DeliveryMethodSettings] (
        [Id] int NOT NULL IDENTITY,
        [Name] nvarchar(50) NOT NULL,
        [SortOrder] int NOT NULL,
        [CreatedAt] datetime2 NOT NULL,
        CONSTRAINT [PK_DeliveryMethodSettings] PRIMARY KEY ([Id])
    );
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260722144625_AddDeliveryMethodSetting', N'8.0.0');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260722150236_AddSortOrderToTaxCategory'
)
BEGIN
    ALTER TABLE [TaxCategories] ADD [SortOrder] int NOT NULL DEFAULT 0;
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260722150236_AddSortOrderToTaxCategory', N'8.0.0');
END;
GO
