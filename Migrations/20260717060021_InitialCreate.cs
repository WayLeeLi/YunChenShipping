        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    PaymentMethod = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShippingOrderDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShippingOrderDetails_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ShippingOrderDetails_ShippingOrders_ShippingOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShippingOrderDetails_ProductId",
                table: "ShippingOrderDetails",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ShippingOrderDetails_ShippingOrderId",
                table: "ShippingOrderDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShippingOrders_OrderDate",
                table: "ShippingOrders",
                column: "OrderDate");

            migrationBuilder.CreateIndex(
                name: "IX_ShippingOrders_OrderNo",
                table: "ShippingOrders",
                column: "OrderNo",
                unique: true);
